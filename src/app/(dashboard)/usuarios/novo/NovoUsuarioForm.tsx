...
export default function NovoUsuarioForm({ filiais, isMaster, activeTenantId }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    senha: "",
    role: "CONSULTOR",
    targetTenantId: activeTenantId, // Inicializa com o tenant ativo
  });
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            {isMaster && filiais.length > 0 && (
              <div className="flex flex-col gap-1 pb-2 border-b border-gray-100">
                <label className="text-sm font-medium text-gray-700">
                  Vincular à Filial <span className="text-red-500">*</span>
                </label>
                <select
                  name="targetTenantId"
                ...
                <p className="text-xs text-gray-500">
                  O usuário terá acesso apenas aos dados (Eventos, Convidados, etc) desta filial específica.
                </p>
              </div>
            )}
